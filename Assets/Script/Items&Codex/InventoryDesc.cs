...
public class InventoryDesc : MonoBehaviour
{
    ...
    public Inventory[] Description = new Inventory[]
    {
        new Inventory {
            Title = "Walkie Talkie",
        ...
        new Inventory {
            Title = "Money bag",
            Decs = "Trusty money bag to bagged away your stolen money. Can be used as a weapon too. Inside, there's " + Player.Instance.Money.ToString() +"money",
        },
        new Inventory {
            Title = "Health Potion",
